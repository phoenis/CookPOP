...
function renderWeekSection(weekIdx){
  ...
  <div class="generate-week-block">
    <button type="button" class="btn is-chip past-days-toggle${state.showPastDays ? ' open' : ''}" data-toggle-past-days="${weekIdx}">Giorni precedenti <svg class="finished-chevron" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 256 256"><path fill="currentColor" d="m213.66 101.66l-80 80a8 8 0 0 1-11.32 0l-80-80a8 8 0 0 1 11.32-11.32L128 164.69l74.34-74.35a8 8 0 0 1 11.32 11.32"></path></svg></button>
    </div>` : '';
