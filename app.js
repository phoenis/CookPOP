...
// sovrappongono.
const TIPO_LABEL = { antipasto:'Antipasto', primo:'Primo', secondo:'Secondo', contorno:'Contorno', unico:'Piatto unico' };
const TIPO_ICON = { antipasto:'🥗', primo:'🍜', secondo:'🍖', contorno:'🥕', unico:'🍽️' };
